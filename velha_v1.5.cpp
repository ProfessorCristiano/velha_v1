...
void fimdejogo()
{
	...
	cout<<"\n";
	cout<<"================================================================================\n";
	cout<<"== O Vencedor é o "<< J<< " com o " << Vencedor <<" No modo " << jogo << "                                   ==\n";
	cout<<"================================================================================\n";
	cout<<"==                                FIM DE JOGO                                 ==\n";
	cout<<"==                                                                            ==\n";  
	cout<<"================================================================================\n";
...
{
	int ale;
	srand((unsigned)time(NULL)); // inicia a função Rand() 
	ale = rand() % 9;  // armazena na variável valor um numero entre 0 e final
	return ale;	
}
